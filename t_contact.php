	                    		...
	                    		if ( $apps_store['apple_store'] || $apps_store['google_play'] ) 
	                    		{
	                    			echo '<div class="follow-us-share__content-btn-group get-app">';
	                    				...
	                    				if ( $apps_store['apple_store'] ) 
	                    				{
	                		        		...
	                		        		$as_logo_url = $apps_store['apple_store_logo_white'] ? $apps_store['apple_store_logo_white']['url'] : get_theme_file_uri( 'images/app-store-white.png' );
	                    				...
	                    				if ( $apps_store['google_play'] ) 
	                    				{
	                		        		...
	                		        		$gp_logo_url = $apps_store['google_play_logo_white'] ? $apps_store['google_play_logo_white']['url'] : get_theme_file_uri( 'images/google-play-white.png' );
